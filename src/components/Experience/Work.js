...
import data from "../Experience/workData.json";
  ...
  return (
    <div className="z-10 flex flex-col items-center justify-center">
      <div className="pb-12 px-4 md:px-12">
        <h1 className="text-xl md:text-3xl lg:text-4xl py-6 font-medium text-left bg-purple-700 text-transparent bg-clip-text">
